...
export interface ProductRepository {
  ...
  findByTenantId(tenantId: string, params: PaginationParams & { active?: boolean; category?: string }): Promise<Result<PaginatedResult<Product>, Error>>;
...
export interface OrderRepository {
  ...
  findByTenantId(tenantId: string, params: PaginationParams & { status?: string; dateFrom?: Date; dateTo?: Date }): Promise<Result<PaginatedResult<Order>, Error>>;
  ...
  getResumen(tenantId: string, from: Date, to: Date): Promise<Result<{ totalPedidos: number; totalVentas: number; ticketPromedio: number }, Error>>;
}

export interface CustomerRepository {
  findById(id: string): Promise<Result<Customer | null, Error>>;
  findByTenantId(tenantId: string, params: PaginationParams & { active?: boolean; search?: string }): Promise<Result<PaginatedResult<Customer>, Error>>;
